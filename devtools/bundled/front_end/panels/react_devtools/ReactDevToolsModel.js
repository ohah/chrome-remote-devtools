...
export class ReactDevToolsModel extends SDK.SDKModel.SDKModel {
    ...
    constructor(target) {
        ...
        bindingsModel.addEventListener("BackendExecutionContextCreated" /* ReactNativeModels.ReactDevToolsBindingsModel.Events.BACKEND_EXECUTION_CONTEXT_CREATED */, this.#handleBackendExecutionContextCreated, this);
        bindingsModel.addEventListener("BackendExecutionContextUnavailable" /* ReactNativeModels.ReactDevToolsBindingsModel.Events.BACKEND_EXECUTION_CONTEXT_UNAVAILABLE */, this.#handleBackendExecutionContextUnavailable, this);
        bindingsModel.addEventListener("BackendExecutionContextDestroyed" /* ReactNativeModels.ReactDevToolsBindingsModel.Events.BACKEND_EXECUTION_CONTEXT_DESTROYED */, this.#handleBackendExecutionContextDestroyed, this);
    ...
    dispose() {
        ...
        this.#bindingsModel.removeEventListener("BackendExecutionContextCreated" /* ReactNativeModels.ReactDevToolsBindingsModel.Events.BACKEND_EXECUTION_CONTEXT_CREATED */, this.#handleBackendExecutionContextCreated, this);
        this.#bindingsModel.removeEventListener("BackendExecutionContextUnavailable" /* ReactNativeModels.ReactDevToolsBindingsModel.Events.BACKEND_EXECUTION_CONTEXT_UNAVAILABLE */, this.#handleBackendExecutionContextUnavailable, this);
        this.#bindingsModel.removeEventListener("BackendExecutionContextDestroyed" /* ReactNativeModels.ReactDevToolsBindingsModel.Events.BACKEND_EXECUTION_CONTEXT_DESTROYED */, this.#handleBackendExecutionContextDestroyed, this);
    ...
    async #initialize() {
        try {
            ...
            this.dispatchEventToListeners("InitializationFailed" /* Events.INITIALIZATION_FAILED */, e instanceof Error ? e.message : String(e));
        }
    }
    isInitialized() {
    ...
    #finishInitializationAndNotify() {
        ...
        this.dispatchEventToListeners("InitializationCompleted" /* Events.INITIALIZATION_COMPLETED */);
    }
    ...
    #handleBackendExecutionContextUnavailable({ data: errorMessage }) {
        this.dispatchEventToListeners("InitializationFailed" /* Events.INITIALIZATION_FAILED */, errorMessage);
    }

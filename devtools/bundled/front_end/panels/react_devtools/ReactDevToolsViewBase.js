...
export class ReactDevToolsViewBase extends UI.View.SimpleView {
    ...
    modelAdded(model) {
        this.#model = model;
        model.addEventListener("InitializationCompleted" /* ReactDevToolsModelEvents.INITIALIZATION_COMPLETED */, this.#handleInitializationCompleted, this);
        model.addEventListener("InitializationFailed" /* ReactDevToolsModelEvents.INITIALIZATION_FAILED */, this.#handleInitializationFailed, this);
    ...
    modelRemoved(model) {
        model.removeEventListener("InitializationCompleted" /* ReactDevToolsModelEvents.INITIALIZATION_COMPLETED */, this.#handleInitializationCompleted, this);
        model.removeEventListener("InitializationFailed" /* ReactDevToolsModelEvents.INITIALIZATION_FAILED */, this.#handleInitializationFailed, this);

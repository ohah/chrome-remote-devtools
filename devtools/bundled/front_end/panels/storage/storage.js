...
var AsyncStorageStoragePanel = class _AsyncStorageStoragePanel extends UI4.Panel.PanelWithSidebar {
  visibleView;
  pendingViewPromise;
  storageViews;
  storageViewToolbar;
...
var StoragePanelSidebar = class extends UI4.Widget.VBox {
  ...
  constructor(panel) {
    ...
    SDK2.TargetManager.TargetManager.instance().observeModels(AsyncStorageStorageModel, {
...
var AsyncStorageOnlyStoragePanelSidebar = class extends UI4.Widget.VBox {
  panel;
  sidebarTree;
  asyncStorageListTreeElement;
  asyncStorageStorageTreeElements;
...
var AsyncStorageStorageTreeElement = class extends StoragePanelTreeElement {
  ...
  constructor(storagePanel, asyncStorageStorage) {
    ...
    this.listItemElement.setAttribute("jslog", `${VisualLogging4.treeItem("async-storage-storage-instance")}`);
  }
  get itemURL() {

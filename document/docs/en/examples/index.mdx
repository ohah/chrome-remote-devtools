...
- `console.log(..., { count, status })` - Expandable object (click the row or arrow in Console to expand/collapse; useful for testing Safari/WebKit)
...
// Expandable object (click in Console to expand/collapse)
console.log('Object:', { count: 1, status: 'ok' });
```

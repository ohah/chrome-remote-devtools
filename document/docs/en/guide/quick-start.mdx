...
For a full, friendly overview and example app, see the [`@ohah/chrome-remote-devtools-inspector-react-native` README](https://github.com/ohah/chrome-remote-devtools/tree/main/packages/react-native-inspector).

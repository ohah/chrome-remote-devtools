...
Pod::Spec.new do |s|
  ...
  # .podspec 파일이 ios/ 디렉토리에 있으므로 상대 경로는 ChromeRemoteDevToolsInspector/ 디렉토리를 가리킴
  # Include TurboModule files (Objective-C++ only, no Swift) / TurboModule 파일 포함 (Objective-C++만, Swift 없음)
  s.source_files = 'ChromeRemoteDevToolsInspector/**/*.{h,mm}'
  s.public_header_files = 'ChromeRemoteDevToolsInspector/**/*.h'

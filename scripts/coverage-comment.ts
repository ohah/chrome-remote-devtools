#!/usr/bin/env bun
// Generate coverage report comment for PR
...
/**
 * Format coverage as markdown comment
 */
...
/**
 * Main function - generates coverage comment for a single package
 */
async function main() {
  // Get package path and name from command line args
